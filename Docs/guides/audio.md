...
Reference: [`download_audio_files`](../reference/man/download_audio_files.md).
...
Reference: [`audio_metadata_tool`](../reference/man/audio_metadata_tool.md).
...
[`audio_conversion_tool`](../reference/man/audio_conversion_tool.md).
...
Reference: [`generate_playlist`](../reference/man/generate_playlist.md).

## Reference

| Command | Purpose |
|---------|---------|
| [`download_audio_files`](../reference/man/download_audio_files.md) | Download audio from curated channels by genre |
| [`audio_metadata_tool`](../reference/man/audio_metadata_tool.md) | Tag / apply / clear audio metadata |
| [`audio_conversion_tool`](../reference/man/audio_conversion_tool.md) | Convert Audible AAX/AA → M4A |
| [`generate_playlist`](../reference/man/generate_playlist.md) | Generate `.m3u` playlists from a tree |
