...
|---------|---------|---------------|
| [`setup_tools`](../reference/man/setup_tools.md) | CLI helper programs | `[UserData.Dirs] tools_dir` |
...
- [`setup_tools`](../reference/man/setup_tools.md) — install/update third-party tools
- [`setup_game_emulators`](../reference/man/setup_game_emulators.md) — install/update emulators
- [`setup_game_assets`](../reference/man/setup_game_assets.md) — create Pegasus asset symlinks
