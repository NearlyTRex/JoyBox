...
Full breakdown: [`master_backup`](../reference/man/master_backup.md).
...
References: [`rebuild_hash_sidecars`](../reference/man/rebuild_hash_sidecars.md) ·
[`find_missing_hash_sidecars`](../reference/man/find_missing_hash_sidecars.md).

## Remote-to-remote and lower-level sync

- [`locker_sync_tool`](../reference/man/locker_sync_tool.md) — interactively sync a primary
  locker to one or more secondaries (e.g. Hetzner → Gdrive + External), with editor-driven
  approval.
- [`sync_tool`](../reference/man/sync_tool.md) — lower-level synchronize between local
  storage and a remote locker.
- [`backup_tool`](../reference/man/backup_tool.md) — copy/archive files between paths with
  optional encryption.

## Reference

- [`master_backup`](../reference/man/master_backup.md)
- [`locker_sync_tool`](../reference/man/locker_sync_tool.md)
- [`rebuild_hash_sidecars`](../reference/man/rebuild_hash_sidecars.md)
- [`find_missing_hash_sidecars`](../reference/man/find_missing_hash_sidecars.md)
- [`sync_tool`](../reference/man/sync_tool.md)
- [`backup_tool`](../reference/man/backup_tool.md)
