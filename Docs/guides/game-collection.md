...
References: [`login_game_stores`](../reference/man/login_game_stores.md) ·
[`build_game_store_purchases`](../reference/man/build_game_store_purchases.md).
...
> the individual tools below. See [`scan_game_files`](../reference/man/scan_game_files.md).
...
References: [`sort_game_metadata`](../reference/man/sort_game_metadata.md) ·
[`publish_game_metadata_files`](../reference/man/publish_game_metadata_files.md).

## Reference

| Command | Purpose |
|---------|---------|
| [`login_game_stores`](../reference/man/login_game_stores.md) | Authenticate with a game store |
| [`build_game_store_purchases`](../reference/man/build_game_store_purchases.md) | Import a store's purchase list into JSON entries |
| [`build_game_json_files`](../reference/man/build_game_json_files.md) | Build JSON entries from files in a locker |
| [`build_game_metadata_files`](../reference/man/build_game_metadata_files.md) | Build metadata entries from JSON |
| [`build_game_hash_files`](../reference/man/build_game_hash_files.md) | Record file hashes for game files |
| [`download_game_metadata_assets`](../reference/man/download_game_metadata_assets.md) | Download artwork / video assets |
| [`scan_game_files`](../reference/man/scan_game_files.md) | Run the whole pipeline end to end |
| [`sort_game_metadata`](../reference/man/sort_game_metadata.md) | Normalize metadata files |
| [`publish_game_metadata_files`](../reference/man/publish_game_metadata_files.md) | Render metadata to HTML |
