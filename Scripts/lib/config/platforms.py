...
microsoft_xbox_one[keys.platform_key_launcher] = [types.LaunchType.NONE.value]
...
microsoft_xbox_one_god[keys.platform_key_launcher] = [types.LaunchType.NONE.value]
...
nintendo_3ds_apps[keys.platform_key_launcher] = [types.LaunchType.NONE.value]
...
apple_ios[keys.platform_key_launcher] = [types.LaunchType.NONE.value]
...
google_android[keys.platform_key_launcher] = [types.LaunchType.NONE.value]
...
sony_playstation_4[keys.platform_key_launcher] = [types.LaunchType.NONE.value]
...
sony_playstation_network_ps4[keys.platform_key_launcher] = [types.LaunchType.NONE.value]
...
sony_playstation_portable_video[keys.platform_key_launcher] = [types.LaunchType.NONE.value]
