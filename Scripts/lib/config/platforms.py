...
class Platform(types.EnumType):
    ...
    # Computer
    COMPUTER_AMAZON_GAMES               = (categories.Category.COMPUTER.value + " - " + categories.Subcategory.COMPUTER_AMAZON_GAMES.value)
    COMPUTER_DISC                       = (categories.Category.COMPUTER.value + " - " + categories.Subcategory.COMPUTER_DISC.value)
    COMPUTER_EPIC_GAMES                 = (categories.Category.COMPUTER.value + " - " + categories.Subcategory.COMPUTER_EPIC_GAMES.value)
    COMPUTER_GOG                        = (categories.Category.COMPUTER.value + " - " + categories.Subcategory.COMPUTER_GOG.value)
    COMPUTER_HUMBLE_BUNDLE              = (categories.Category.COMPUTER.value + " - " + categories.Subcategory.COMPUTER_HUMBLE_BUNDLE.value)
    COMPUTER_ITCHIO                     = (categories.Category.COMPUTER.value + " - " + categories.Subcategory.COMPUTER_ITCHIO.value)
    COMPUTER_LEGACY_GAMES               = (categories.Category.COMPUTER.value + " - " + categories.Subcategory.COMPUTER_LEGACY_GAMES.value)
    COMPUTER_PUPPET_COMBO               = (categories.Category.COMPUTER.value + " - " + categories.Subcategory.COMPUTER_PUPPET_COMBO.value)
    COMPUTER_RED_CANDLE                 = (categories.Category.COMPUTER.value + " - " + categories.Subcategory.COMPUTER_RED_CANDLE.value)
    COMPUTER_SQUARE_ENIX                = (categories.Category.COMPUTER.value + " - " + categories.Subcategory.COMPUTER_SQUARE_ENIX.value)
    COMPUTER_STEAM                      = (categories.Category.COMPUTER.value + " - " + categories.Subcategory.COMPUTER_STEAM.value)
    COMPUTER_ZOOM                       = (categories.Category.COMPUTER.value + " - " + categories.Subcategory.COMPUTER_ZOOM.value)
    ...
    # Other
    OTHER_APPLE_IOS                     = (categories.Subcategory.OTHER_APPLE_IOS.value)
    OTHER_APPLE_MACOS_8                 = (categories.Subcategory.OTHER_APPLE_MACOS_8.value)
    OTHER_ARCADE                        = (categories.Subcategory.OTHER_ARCADE.value)
    OTHER_ATARI_800                     = (categories.Subcategory.OTHER_ATARI_800.value)
    OTHER_ATARI_2600                    = (categories.Subcategory.OTHER_ATARI_2600.value)
    OTHER_ATARI_5200                    = (categories.Subcategory.OTHER_ATARI_5200.value)
    OTHER_ATARI_7800                    = (categories.Subcategory.OTHER_ATARI_7800.value)
    OTHER_ATARI_JAGUAR                  = (categories.Subcategory.OTHER_ATARI_JAGUAR.value)
    OTHER_ATARI_JAGUAR_CD               = (categories.Subcategory.OTHER_ATARI_JAGUAR_CD.value)
    OTHER_ATARI_LYNX                    = (categories.Subcategory.OTHER_ATARI_LYNX.value)
    OTHER_BANDAI_WONDERSWAN             = (categories.Subcategory.OTHER_BANDAI_WONDERSWAN.value)
    OTHER_BANDAI_WONDERSWAN_COLOR       = (categories.Subcategory.OTHER_BANDAI_WONDERSWAN_COLOR.value)
    OTHER_COLECO_COLECOVISION           = (categories.Subcategory.OTHER_COLECO_COLECOVISION.value)
    OTHER_COMMODORE_64                  = (categories.Subcategory.OTHER_COMMODORE_64.value)
    OTHER_COMMODORE_AMIGA               = (categories.Subcategory.OTHER_COMMODORE_AMIGA.value)
    OTHER_GOOGLE_ANDROID                = (categories.Subcategory.OTHER_GOOGLE_ANDROID.value)
    OTHER_MAGNAVOX_ODYSSEY_2            = (categories.Subcategory.OTHER_MAGNAVOX_ODYSSEY_2.value)
    OTHER_MATTEL_INTELLIVISION          = (categories.Subcategory.OTHER_MATTEL_INTELLIVISION.value)
    OTHER_NEC_PCENGINE                  = (categories.Subcategory.OTHER_NEC_PCENGINE.value)
    OTHER_NEC_PCENGINE_CD               = (categories.Subcategory.OTHER_NEC_PCENGINE_CD.value)
    OTHER_NEC_SUPERGRAFX                = (categories.Subcategory.OTHER_NEC_SUPERGRAFX.value)
    OTHER_NEC_TURBOGRAFX_16             = (categories.Subcategory.OTHER_NEC_TURBOGRAFX_16.value)
    OTHER_NEC_TURBOGRAFX_CD             = (categories.Subcategory.OTHER_NEC_TURBOGRAFX_CD.value)
    OTHER_NOKIA_NGAGE                   = (categories.Subcategory.OTHER_NOKIA_NGAGE.value)
    OTHER_PANASONIC_3DO                 = (categories.Subcategory.OTHER_PANASONIC_3DO.value)
    OTHER_PHILIPS_CDI                   = (categories.Subcategory.OTHER_PHILIPS_CDI.value)
    OTHER_SNK_NEOGEO_POCKET_COLOR       = (categories.Subcategory.OTHER_SNK_NEOGEO_POCKET_COLOR.value)
    OTHER_SEGA_32X                      = (categories.Subcategory.OTHER_SEGA_32X.value)
    OTHER_SEGA_CD                       = (categories.Subcategory.OTHER_SEGA_CD.value)
    OTHER_SEGA_CD_32X                   = (categories.Subcategory.OTHER_SEGA_CD_32X.value)
    OTHER_SEGA_DREAMCAST                = (categories.Subcategory.OTHER_SEGA_DREAMCAST.value)
    OTHER_SEGA_GAME_GEAR                = (categories.Subcategory.OTHER_SEGA_GAME_GEAR.value)
    OTHER_SEGA_GENESIS                  = (categories.Subcategory.OTHER_SEGA_GENESIS.value)
    OTHER_SEGA_MASTER_SYSTEM            = (categories.Subcategory.OTHER_SEGA_MASTER_SYSTEM.value)
    OTHER_SEGA_SATURN                   = (categories.Subcategory.OTHER_SEGA_SATURN.value)
    OTHER_SINCLAIR_ZX_SPECTRUM          = (categories.Subcategory.OTHER_SINCLAIR_ZX_SPECTRUM.value)
    OTHER_TEXAS_INSTRUMENTS_TI994A      = (categories.Subcategory.OTHER_TEXAS_INSTRUMENTS_TI994A.value)
    OTHER_TIGER_GAMECOM                 = (categories.Subcategory.OTHER_TIGER_GAMECOM.value)
