...
def ConvertFromNativePath(path, user_id):
    src_path = os.path.join(config.computer_folder_store, config.StoreType.STEAM.cvalue, "userdata", user_id)
...
def ConvertToNativePath(path, user_id):
    ...
    dest_path = os.path.join(config.computer_folder_store, config.StoreType.STEAM.cvalue, "userdata", user_id)
    return path.replace(src_path, dest_path)
...
def ConvertToNativeSave(
    ...
    # Get relative paths
    roaming_path = os.path.join(config.SaveType.GENERAL.cvalue, config.computer_folder_appdata, "Roaming")
    search_path = os.path.join(config.SaveType.GENERAL.cvalue, config.computer_folder_appdata, "Roaming", "Goldberg SteamEmu Saves")
    ignore_path = os.path.join(config.SaveType.GENERAL.cvalue, config.computer_folder_appdata, "Roaming", "Goldberg SteamEmu Saves", "settings")
    replace_path = os.path.join(config.SaveType.GENERAL.cvalue, config.computer_folder_store, config.StoreType.STEAM.cvalue, "userdata", user_id)
